            ...
            <div class="menu-bg-wrap">
                <div class="site-navigation">
                    <div class="row g-0 align-items-center">
                        <div class="col-2">
                            <a href="<?= url_to('home'); ?>" class="logo m-0 float-start">Blogy<span class="text-primary">.</span></a>
                        </div>
                        <div class="col-8 text-center">
                            ...
                            <ul class="navbar-nav mr-auto js-clone-nav d-none d-lg-inline-block text-start site-menu mx-auto">
                                <li class="active"><a href="<?= url_to('home'); ?>">Home</a></li>

                                <li><a href="<?php echo base_url('posts/category' . '/culture'); ?>">Culture</a></li>
                                <li><a href="<?php echo base_url('posts/category' . '/business'); ?>">Business</a></li>
                                <li><a href="<?php echo base_url('posts/category' . '/politics'); ?>">Politics</a></li>
                                <?php if (isset(auth()->user()->id)): ?>
                                    <li><a href="<?php echo base_url('posts/create-post'); ?>">Create Post</a></li>
                                <?php endif; ?>
                                <li><a href="<?= url_to('contact'); ?>">Contact Us</a></li>
                                ...
                                <?php else: ?>
                                    <li class="has-children">
                                        ...
                                        <ul class="dropdown">
                                            <li><a href="<?php echo url_to('my.post'); ?>">My Posts</a></li>
                        ...
                        <div class="col-2 text-end">
                            ...
                            <form action="<?= url_to('search'); ?>" method="POST" class="search-form d-none d-lg-inline-block">
