...
<section class="section">
    <div class="container">
        ...
        <div class="row">
            <?php foreach ($politicsThreePosts as $post) : ?>
                <div class="col-md-6 col-lg-3">
                    <div class="blog-entry">
                        <a href="<?= base_url('posts/single/' . $post->id . ''); ?>" class="img-link">
                            <img src="<?= base_url('public/assets/images/' . $post->image . ''); ?>" alt="Image" class="img-fluid">
    ...
    <div class="container">
        ...
        <div class="row align-items-stretch retro-layout-alt">
            ...
            <div class="col-md-5 order-md-2">
                <?php foreach ($travel as $post) : ?>
                    <a href="<?= base_url('posts/single/' . $post->id . ''); ?>" class="hentry img-1 h-100 gradient">
            ...
            <div class="col-md-7">
                <?php foreach ($travel as $post) : ?>
                    <a href="<?= base_url('posts/single/' . $post->id . ''); ?>" class="hentry img-2 v-height mb30 gradient">
                        <div class="featured-img" style="background-image: url('<?= base_url('public/assets/images/' . $post->image . '') ?>');"></div>
                ...
                <div class="two-col d-block d-md-flex justify-content-between">
                    <?php foreach ($travelTwoPosts as $post) : ?>
                        <a href="<?= base_url('posts/single/' . $post->id . ''); ?>" class="hentry v-height img-2 gradient">
                            <div class="featured-img" style="background-image: url('<?= base_url('public/assets/images/' . $post->image . '') ?>');"></div>
                            <div class="text text-sm">
                                <span><?= $post->created_at ?></span>
                                <h2><?= $post->title ?></h2>
