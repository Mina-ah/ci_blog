            ...
            <div class="col-md-12 col-lg-8 main-content">
                ...
                <?php if (isset(auth()->user()->id)): ?>
                    <?php if ($data['user_id'] == auth()->user()->id): ?>
                        <a class="btn btn-danger" href="<?php echo url_to('post.delete', $data['id']); ?>">delete</a>
                        <a class="btn btn-warning" href="<?php echo url_to('post.update', $data['id']); ?>">update</a>
                    <?php endif; ?>
                <?php endif; ?>
                <div class="pt-5">
                ...
                <div class="pt-5 comment-wrap">
                  ...
                  <img src="images/person_1.jpg" alt="Image placeholder">
                            ...
                            <?php endforeach; ?>
                        <?php else: ?>
                            <p class="alert alert-success">No comments for this post yet!</p>
                        <?php endif; ?>
                    </ul>
                    <!-- END comment-list -->
                    ...
                    <div class="comment-form-wrap pt-5">
                        ...
                        <?php if (isset(auth()->user()->id)): ?>
                            <form action="<?= base_url('posts/store-comment/' . $data['id'] . ''); ?>" method="POST" class="p-5 bg-light">
                        ...
                        <?php else: ?>
                            <p class="alert alert-success">Login to Comment</p>
                        <?php endif; ?>
                    </div>
                </div>
