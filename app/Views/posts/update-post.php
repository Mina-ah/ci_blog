...
<div class="container">
    <div class="comment-form-wrap pt-5">
        ...
        <form action="<?php echo url_to('post.edit',$singlePost['id']); ?>" method="POST" class="p-5 bg-light" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select name="category" class="form-select" aria-label="Default select example">
                    ...
                    <option value="travel"><?= $category->name; ?></option>
                    <?php endforeach; ?>
